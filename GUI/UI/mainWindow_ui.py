...
# Form implementation generated from reading ui file 'D:\YandexDisk\Work\ProjectsRepositories\20230821_RousettusDataProcessing\RousettusDataProcessing\GUI\UI\mainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuGNSS_Data = QtWidgets.QMenu(self.data_processing_menu)
        self.menuGNSS_Data.setObjectName("menuGNSS_Data")
        self.menuSpectromery_data = QtWidgets.QMenu(self.data_processing_menu)
        self.menuSpectromery_data.setObjectName("menuSpectromery_data")
        ...
        self.action_import_gnss = QtWidgets.QAction(MainWindow)
        self.action_import_gnss.setObjectName("action_import_gnss")
        self.action_import_spectrum = QtWidgets.QAction(MainWindow)
        self.action_import_spectrum.setObjectName("action_import_spectrum")
        self.menuGNSS_Data.addAction(self.action_import_gnss)
        self.menuSpectromery_data.addAction(self.action_import_spectrum)
        self.data_processing_menu.addAction(self.menuSpectromery_data.menuAction())
        self.data_processing_menu.addAction(self.menuGNSS_Data.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Rousettus Data Processing"))
        ...
        self.menuGNSS_Data.setTitle(_translate("MainWindow", "GNSS Data"))
        self.menuSpectromery_data.setTitle(_translate("MainWindow", "Spectromery data"))
        ...
        self.action_import_gnss.setText(_translate("MainWindow", "Import"))
        self.action_import_spectrum.setText(_translate("MainWindow", "Import data"))
